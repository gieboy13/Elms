    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main style="color: black;" class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div style="color: black; font-size: 25px;" class="page-title">Manage Departments</div>
                    </div>
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="empdep.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->DepartmentName);?></td>
