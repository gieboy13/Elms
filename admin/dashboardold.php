...
?>   
                 ...
                 <div class="col s12 m12 l4">
                        <div style="background-color: transparent; border: gray 3px solid; width: 250px; height: 240px; right: 10px; top: 70px; position: absolute;" class="card stats-card">
                            <div class="card-content">
                                <span style="color: black; font-size: 15px;" class="card-title">TOP 5 EMPLOYEE WITH MOST NUMBER OF APPLIED LEAVES</span>
                                    <?php
                                    if($query->rowCount() > 0)
    
$sql = "SELECT l.empid, concat (e.FirstName, ' ', e.LastName) as NAME, COUNT(l.empid) as t
...
foreach($results as $result)
{
    ...
    print_r($result->t . " Leave/s - " .  $result->NAME);
?>   
<br>
 ...
 <div class="col s12 m12 l4">
                        <div style="background-color: transparent; border: gray 3px solid; width: 250px; height: 510px; right: 10px; top: 320px; position: absolute;" class="card stats-card">
                            <div class="card-content">
...
foreach($results as $result)
{
    ...
    print_r($result->t . " Leave/s - " .  $result->DEPARTMENT);
?>   
<br>
...
<div id="canv"><canvas id="myChart" width="50" height="50"></canvas></div>
<style>
    #canv {
k;
      width: 700px;
