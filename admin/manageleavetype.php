    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div style="color: black; font-size: 25px;" class="page-title">Manage Leave Type</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div style="background-color: transparent; border: gray 5px solid;" class="card">
                            <div class="card-content">
                                <span style="color: black; font-size: 15px;" class="card-title">Leave Type Info</span>
