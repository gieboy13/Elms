  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div style="color: black; font-size: 25px;" class="page-title">Add Leave Type</div>
                    </div>
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype"  required>
                                                <label style="color: black;" for="leavetype">Leave Type</label>
                                            </div>


          <div style="color: black;" class="input-field col s12">
<textarea id="textarea1" name="description" class="materialize-textarea" name="description" length="500"></textarea>
                                                <label style="color: black;" for="deptshortname">Description</label>
                                            </div>
