...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT empcredits.sick_credits, empcredits.vacation_credits, tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.AdminRemarkDate,tblleaves.AdminRemark,tblleaves.Status from tblleaves JOIN empcredits ON tblleaves.empid=empcredits.empid where tblleaves.empid=:eid";
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Rejected</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue; font-weight: bold;">waiting for approval</span>
 <?php } ?>
