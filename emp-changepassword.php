...
.succWrap{
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <img style="height: 370px; width: 370px; right: 40px; position: absolute; bottom: 50px;" src="pup.png">   
                <div class="row">
                    <div class="col s12">
                        <div style="color: black; font-size: 25px;" class="page-title">Change Pasword</div>
                    </div>
...
<input style="color: black;" id="password" type="password"  class="validate" autocomplete="off" name="password"  required>
...
<div class="input-field col s12">
<input style="color: black;" id="password" type="password" name="confirmpassword" class="validate" autocomplete="off" required>
