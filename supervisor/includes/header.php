        ...
        <div class="mn-content fixed-sidebar">
            <header  class="mn-header navbar-fixed">
                <nav style="background-color: rgba(255, 168, 1,1.0);">
                    <div class="nav-wrapper row">
                        <img style="width: 50px; left: 220px; position: absolute;top: 5px;" src="pup.png">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">PUP LMS | Supervisor</span>
